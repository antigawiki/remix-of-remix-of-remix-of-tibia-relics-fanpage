...
export const sorcererSpells: Spell[] = [
  ...
  { name: "Light Magic Missile", words: "adori", image: "https://tibiara.netlify.app/en/img/runes/light_magic_missile.gif", level: 15, mana: 40, price: "500 gp", isPremium: false, type: "Attack" },
  { name: "Heavy Magic Missile", words: "adori gran", image: "https://tibiara.netlify.app/en/img/runes/heavy_magic_missile.gif", level: 25, mana: 70, price: "1500 gp", isPremium: false, type: "Attack" },
  ...
  { name: "Great Fireball", words: "adori mas flam", image: "https://tibiara.netlify.app/en/img/runes/great_fireball.gif", level: 30, mana: 120, price: "1800 gp", isPremium: false, type: "Attack" },
  ...
  { name: "Sudden Death", words: "adori gran mort", image: "https://tibiara.netlify.app/en/img/runes/sudden_death.gif", level: 45, mana: 200, price: "3000 gp", isPremium: false, type: "Attack" },
  { name: "Ultimate Explosion", words: "adevo mas hur", image: "https://tibiara.netlify.app/en/img/runes/ultimate_explosion.gif", level: 60, mana: 300, price: "4000 gp", isPremium: true, type: "Attack" },
