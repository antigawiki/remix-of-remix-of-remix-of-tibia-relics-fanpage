...
import { 
  ...
  Info, Trophy, Clock, Package, Users, Skull, TrendingUp, Sparkles, Monitor, Swords, Target, Home, Film, BarChart3
} from 'lucide-react';
      ...
      <aside className="space-y-4">
        ...
        <div className="wood-panel rounded-sm overflow-hidden">
          ...
          <nav className="divide-y divide-border/30">
            ...
            <Link to="/polls" className="sidebar-menu-item flex items-center gap-2">
            ...
            <Link to="/kill-statistics" className="sidebar-menu-item flex items-center gap-2">
            ...
            <Link to="/hunt-admin" className="sidebar-menu-item flex items-center gap-2">
